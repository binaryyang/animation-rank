    ...
    console.log(
      JSON.stringify({
        ...
        checks: [
          ...
          "global undo/redo and undoable deletion",
          "remove and edit anime",
          "file-backed covers and JSON re-embedding",
          "quick rating skip and revisit",
          "board keyboard ranking",
